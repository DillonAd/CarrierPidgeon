...
namespace CarrierPidgeon.Test.CarrierPidgeon
{
    public class EventDrivenInterfaceManager_Tests
    {
        ...
        {
            //Assemble
            var edi = new Mock<IEventDriven<ISender<IEntity>, IEventDrivenReceiver>>().Object;
        ...
        {
            //Assemble
            var mock = new Mock<IEventDriven<ISender<IEntity>, IEventDrivenReceiver>>();
        ...
        public void StartInterfaces()
        {
            ...
            var mock1 = new Mock<IEventDriven<ISender<IEntity>, IEventDrivenReceiver>>();
